...
import static org.mule.jms.commons.api.destination.DestinationType.QUEUE;
import static org.mule.jms.commons.api.destination.DestinationType.TOPIC;
import static org.mule.jms.commons.internal.message.JmsMessageUtils.getPropertiesMap;
import static org.mule.jms.commons.internal.message.JmsMessageUtils.toObject;
...
public class JmsResultFactory<T extends JmsAttributes> {
   ...
   * @throws JMSException
   */
  public Result<Object, T> createResult(Message jmsMessage, JmsSpecification specification, String contentType,
    ...
    return Result.<Object, T>builder()
  ...
  public Result<Object, T> createEmptyResult() {
    return Result.<Object, T>builder().output(null).build();
  }

  private T createJmsAttributes(JmsHeaders jmsHeaders, JmsMessageProperties jmsProperties,
