...
import org.mule.jms.commons.api.config.ConsumerAckMode;
...
import org.mule.jms.commons.internal.config.IJmsConfig;
 ...
 * @since 1.0
 */
public class JmsConsume<A extends JmsAttributes, C extends ConsumerType> {
  ...
  public Result<Object, A> consumeTwo(@Config IJmsConfig config,
                                      ...
                                      @ConfigOverride @Summary("The Type of the Consumer that should be used for the provided destination") C consumerType,
    ...
    try {
      ...
      Result<Object, A> result = resultFactory.createResult(received, jmsSupport.getSpecification(),
  ...
  private InternalAckMode resolveAck(IJmsConsumerConfig config, ConsumerAckMode ackMode) {
