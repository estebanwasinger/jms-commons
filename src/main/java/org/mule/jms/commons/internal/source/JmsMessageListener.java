...
import static org.mule.jms.commons.internal.source.JmsListener.notifyIfConnectionProblem;
 ...
 * @since 1.0
 */
public final class JmsMessageListener<T extends JmsAttributes> implements MessageListener {
  ...
  public void onMessage(Message message) {
    ...
    try {
      ...
      JmsListener.notifyIfConnectionProblem(sourceCallback, e);
    }
  ...
  private void dispatchMessage(Message message, SourceCallbackContext context, String encoding, String contentType) {
    try {
      ...
      sourceCallback.handle((Result<Object, T>) result, context);
