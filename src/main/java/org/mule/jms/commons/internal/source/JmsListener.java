...
public class JmsListener<T extends JmsAttributes> extends Source<Object, T> {
  ...
  @Override
  public void onStart(SourceCallback<Object, T> sourceCallback) throws MuleException {
