 ...
 * @since 1.0
 */
public class BaseConnectionProvider implements CachedConnectionProvider<JmsTransactionalConnection>, Initialisable, Disposable {
  ...
  public BaseConnectionProvider(JmsSessionManager jmsSessionManager, Supplier<ConnectionFactory> connectionFactorySupplier, JmsSpecification specification, GenericConnectionParameters connectionParameters, CachingStrategy cachingStrategy) {
